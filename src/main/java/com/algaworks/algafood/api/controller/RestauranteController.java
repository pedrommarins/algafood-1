...
public class RestauranteController {
	...
	public ResponseEntity<?> atualizar(@PathVariable Long restaurantesId, @RequestBody Restaurante restaurante) {

			
			
		try {
				
			Restaurante restauranteAtual = restauranteRepository.findById(restaurantesId).orElse(null);
	...
	public ResponseEntity<?> atualizarParcial(@PathVariable Long restaurantesId,
